  ...
  return <div className="flex-1 flex items-center justify-center py-16 px-6">
      <div className="text-center max-w-2xl mx-auto mt-[100px]">
        <div className="mb-10">
          ...
          <p className="text-2xl text-muted-foreground max-w-lg mx-auto">Agentforce is our digital assistant built to help Primacy connect faster with prospective clients.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-5xl mx-auto">
          <div className="flex gap-3">
            ...
            <Button type="submit" size="lg" disabled={!inputValue.trim()} className="bg-primary hover:bg-primary-dark h-16 px-8 text-lg">
              Start Chat
            </Button>
          </div>
        </form>
